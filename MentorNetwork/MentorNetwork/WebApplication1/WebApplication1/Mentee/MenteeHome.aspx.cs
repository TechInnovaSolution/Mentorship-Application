...
namespace WebApplication1
{
    public partial class MenteeHome : System.Web.UI.Page
    {
        ...
        string menGen, menLoc, menQual, menUni, menInd, menCom, menOcc, menYExp, menMExp;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!(IsPostBack) && (isValid == true))
            {
                ...
                int cnt = 0, num =0;
                string selectMentorQuery = "SELECT * FROM Mentor";
                ...
                while (readerr.HasRows)
                {
                    while (readerr.Read())
                    {
                        ...
                        menYExp = readerr.GetString(14);
                        menMExp = readerr.GetString(15);
